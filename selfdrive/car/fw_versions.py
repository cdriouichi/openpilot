...
def match_fw_to_car_exact(fw_versions_dict):
  ...
  for candidate, fws in candidates.items():
    for ecu, expected_versions in fws.items():
      ...
      if ecu_type == Ecu.esp and candidate in [TOYOTA.RAV4, TOYOTA.COROLLA, TOYOTA.HIGHLANDER, TOYOTA.SIENNA, TOYOTA.LEXUS_IS, TOYOTA.YARIS] and found_version is None:
        continue
